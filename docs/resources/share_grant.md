...
This resource owns one grant. To review direct grants and the whole-organization or public audience created by the share's `access` mode, read [motherduck_share_grants](../data-sources/share_grants.md).
