...
The username is the resource identity. It must be 3 to 255 characters, start
with an ASCII letter, and continue with letters, digits, or underscores.
Renaming replaces the account.
...
- `username` (String) Unique service account username. Must be 3-255 characters, start with an ASCII letter, and contain only ASCII letters, digits, and underscores.
