...
description: |-
  Lists runs for one MotherDuck Flight. MotherDuck returns the 50 newest runs when limit is omitted, so set limit and offset to read more. Rows in the returned page are sorted newest run first.
---
