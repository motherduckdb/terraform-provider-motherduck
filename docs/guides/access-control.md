...
The [example](https://github.com/motherduckdb/terraform-provider-motherduck/blob/v0.3.0/examples/access-control/README.md) maps each team to a role
...
Copy the [example](https://github.com/motherduckdb/terraform-provider-motherduck/blob/v0.3.0/examples/access-control/README.md) into a Terraform
...
[read-only share audit example](https://github.com/motherduckdb/terraform-provider-motherduck/blob/v0.3.0/examples/share-access-audit/README.md).
...
The [role access audit example](https://github.com/motherduckdb/terraform-provider-motherduck/blob/v0.3.0/examples/role-access-audit/README.md)
